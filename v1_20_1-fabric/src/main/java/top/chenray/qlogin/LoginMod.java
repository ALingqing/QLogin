...
/**
 * 登录系统 Mod 主入口 - Minecraft 1.20.1 (Fabric)
 */
public class LoginMod implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        LOGGER.info("======================================");
        LOGGER.info("  登录系统 LoginMod v{} (1.20.1 Fabric)", "?");
        LOGGER.info("======================================");

        // 注册版本适配器
        TitleHelper.setInstance(new v1_20_1TitleHelper());
        ...
        LOGGER.info("登录系统 LoginMod 1.20.1 Fabric 加载完成");
    }

    /** 1.20.1 Title 适配器 */
    @SuppressWarnings("unchecked")
    private static class v1_20_1TitleHelper implements TitleHelper {
        @Override
