...
public class TextUtils {
    ...
    public static MutableText success(String text) { return Text.literal("§a" + text); }
    public static MutableText error(String text) { return Text.literal("§c" + text); }
    public static MutableText warning(String text) { return Text.literal("§e" + text); }
    public static MutableText info(String text) { return Text.literal("§b" + text); }
}
